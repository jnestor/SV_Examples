...
#set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { tmp_rdy }]; #IO_L18P_T2_A24_15 Sch=led[0]
#set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { tmp_err }]; #IO_L24P_T3_RS1_15 Sch=led[1]
#set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { tst_led }]; #IO_L17N_T2_A25_15 Sch=led[2]
...
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { adv_hr }]; #IO_L12P_T1_MRCC_14 Sch=btnl
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { adv_min }]; #IO_L10N_T1_D15_14 Sch=btnr
